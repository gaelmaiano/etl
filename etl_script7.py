...
def main():
    ...
    try:
        ...
        df_commandes_csv = df_csv.rename(columns={
            ...
            # ATTENTION : Si la colonne dans votre CSV est 'revendeer_id', gardez-la ainsi.
            # Sinon, assurez-vous que c'est 'revendeur_id' ou le nom correct.
            'revendeur_id': 'id_revendeur', 
            'region_id': 'id_region', # Si cette colonne doit être dans les commandes ou juste les lignes
